...
import type { FavoriteCustomer } from "../profile-view-utils/profile-view-types"

interface ProfileEarningsSectionProps {
  favoriteCustomers: FavoriteCustomer[]
}

export function ProfileEarningsSection({ favoriteCustomers }: ProfileEarningsSectionProps) {
  return (
