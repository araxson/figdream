...
// import { MapPin, Search } from 'lucide-react' // Unused imports
...
export default async function BookingPage() {
  ...
  const salonsWithStats = salons.map((salon: Salon) => {
    ...
    // Get first location for salon (if any)
    const firstLocation = (salon as Database['public']['Tables']['salons']['Row'] & { salon_locations?: Array<{ address?: string; city?: string }> }).salon_locations?.[0]
    
    return {
      ...salon,
      image_url: salon.logo_url || null,
      address_line_1: firstLocation?.address || null,
