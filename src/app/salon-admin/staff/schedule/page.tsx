                                ...
                                <div className="flex items-center gap-3">
                                  ...
                                  <div>
                                    <p className="font-medium">
                                      {schedule.staff_profiles?.display_name || 'Staff Member'}
                                    </p>
                          ...
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              <h4 className="font-semibold">
                                {staff.display_name || staff.profiles?.full_name}
                              </h4>
                              <p className="text-sm text-muted-foreground">
                ...
                {breaks.map((breakItem) => (
                  <div key={breakItem.id} className="flex items-center justify-between p-3 border rounded-lg">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="font-medium">
                          {breakItem.staff_profiles?.display_name}
                        </p>
                        <p className="text-sm text-muted-foreground">
                ...
                {timeOffRequests.map((request) => (
                  <div key={request.id} className="p-4 border rounded-lg">
                    <div className="flex justify-between items-start">
                      <div>
                        <p className="font-medium">
                          {request.staff_profiles?.display_name}
                        </p>
