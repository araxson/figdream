 ...
 */
export async function createBookingAction(formData: FormData | Record<string, unknown>) {
  try {
 ...
 */
export async function updateBookingAction(formData: FormData | Record<string, unknown>) {
  try {
    const data = typeof formData === 'object' && !(formData instanceof FormData) 
      ? formData 
      : Object.fromEntries(formData.entries())
 ...
 * Cancel a booking
 */
export async function cancelBookingAction(formData: FormData | Record<string, unknown>) {
  try {
    const data = typeof formData === 'object' && !(formData instanceof FormData) 
      ? formData 
      : Object.fromEntries(formData.entries())
 ...
 */
export async function rescheduleBookingAction(formData: FormData | Record<string, unknown>) {
  try {
    const data = typeof formData === 'object' && !(formData instanceof FormData) 
      ? formData 
      : Object.fromEntries(formData.entries())
 ...
 */
export async function checkAvailabilityAction(formData: FormData | Record<string, unknown>) {
  try {
    const data = typeof formData === 'object' && !(formData instanceof FormData) 
      ? formData 
      : {
