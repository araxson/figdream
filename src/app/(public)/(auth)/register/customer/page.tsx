...
export default function CustomerRegistrationPage() {
  return (
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-lg">Why Join FigDream?</CardTitle>
        </CardHeader>
        <CardContent>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div className="space-y-1">
                ...
                <p className="text-sm text-muted-foreground">
                  Book appointments 24/7 with your favorite salons
                </p>
              </div>
            </div>
            <div className="flex items-start space-x-3">
              ...
              <div className="space-y-1">
                ...
                <p className="text-sm text-muted-foreground">
                  Save your preferences and favorite services
                </p>
              </div>
            </div>
            <div className="flex items-start space-x-3">
              ...
              <div className="space-y-1">
                ...
                <p className="text-sm text-muted-foreground">
                  Earn points and unlock special offers with every visit
                </p>
              </div>
            </div>
          </div>
