...
function _shouldSendEmail(type: string, settings: NotificationSettings): boolean {
...
function _shouldSendSMS(type: string, settings: NotificationSettings): boolean {
...
function _shouldSendPush(type: string, settings: NotificationSettings): boolean {
