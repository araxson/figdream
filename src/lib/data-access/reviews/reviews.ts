...
type _ReviewInsert = Database['public']['Tables']['reviews']['Insert']
 ...
 */
async function notifyCustomerAboutModeration(_reviewId: string, _message: string): Promise<void> {
  // Implement notification logic
}
/**
 * Notify customer about response
 */
async function notifyCustomerAboutResponse(_reviewId: string): Promise<void> {
  // Implement notification logic
}