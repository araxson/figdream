...
import RewardDialog from '@/components/salon-owner/loyalty/reward-dialog'
...
export default async function LoyaltyRewardsPage() {
  ...
  // Get rewards
  // loyalty_rewards table doesn't exist in database - using empty array
  const rewards: any[] = await getLoyaltyRewards(userRole.salon_id)
