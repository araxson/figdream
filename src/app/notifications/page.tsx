...
export default function NotificationCenterPage() {
    ...
    try {
      ...
      if (!settingsError && settingsData) {
        ...
        setSettingsForm({
          ...
          email_reviews: settingsData.email_reviews ?? true,
          email_staff_updates: settingsData.email_staff_updates ?? true,
          email_system_alerts: settingsData.email_system_alerts ?? true,
          ...
          sms_confirmations: settingsData.sms_confirmations ?? true,
          ...
          push_alerts: settingsData.push_alerts ?? true,
          quiet_hours_enabled: settingsData.quiet_hours_enabled ?? false,
          quiet_hours_start: settingsData.quiet_hours_start ?? '22:00',
          quiet_hours_end: settingsData.quiet_hours_end ?? '08:00',
  ...
  function getActionUrl(notif: Notification): string | undefined {
    ...
    if (metadata?.appointment_id) return `/appointments/${metadata.appointment_id}`;
    if (metadata?.review_id) return `/reviews/${metadata.review_id}`;
    return undefined;
  }
          ...
          <CardContent className="space-y-6">
                ...
                <div className="ml-6 space-y-2">
                  <label className="flex items-center space-x-2">
                    <input
                      ...
                      onChange={(e) => setSettingsForm(prev => ({ ...prev, email_appointments: e.target.checked }))}
                      className="rounded"
                    />
                    <span className="text-sm">Appointment updates</span>
                  </label>
                  <label className="flex items-center space-x-2">
                    <input
                      type="checkbox"
                      checked={settingsForm.email_reviews}
                      onChange={(e) => setSettingsForm(prev => ({ ...prev, email_reviews: e.target.checked }))}
                      className="rounded"
                    />
                  ...
                  <label className="flex items-center space-x-2">
                    <input
                      ...
                      onChange={(e) => setSettingsForm(prev => ({ ...prev, email_marketing: e.target.checked }))}
                      className="rounded"
                    />
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-2">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) => setSettingsForm(prev => ({ ...prev, sms_notifications: checked }))}
                />
              </div>
                ...
                <div className="ml-6 space-y-2">
                  <label className="flex items-center space-x-2">
                    <input
                      ...
                      onChange={(e) => setSettingsForm(prev => ({ ...prev, sms_appointments: e.target.checked }))}
                      className="rounded"
                    />
                  ...
                  <label className="flex items-center space-x-2">
                    <input
                      ...
                      onChange={(e) => setSettingsForm(prev => ({ ...prev, sms_reminders: e.target.checked }))}
                      className="rounded"
                    />
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-2">
                ...
                <Switch
                  checked={settingsForm.quiet_hours_enabled}
                  onCheckedChange={(checked) => setSettingsForm(prev => ({ ...prev, quiet_hours_enabled: checked }))}
                />
              </div>
