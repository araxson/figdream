...
import { RevenueSection } from '@/components/salon-owner/dashboard/revenue-section'
import { DashboardPanels } from '@/components/salon-owner/dashboard/dashboard-panels'
import {
  Breadcrumb,
  BreadcrumbItem,
  BreadcrumbLink,
...
export default async function DashboardPage() {
  ...
  const weeklyRevenueTotal = weeklyRevenue.data?.reduce((sum, apt) => sum + (apt.total_amount || 0), 0) || 0
    ...
    <div className="space-y-6">
      ...
      <Alert>
        ...
        <AlertDescription className="flex items-center justify-between">
          <span>All systems operational. Last sync: 2 minutes ago</span>
