...
// NotificationSettingsForm component doesn't exist - removed import
    ...
    <div className="container max-w-4xl py-8 space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {(settings.email_appointments || settings.email_reminders || settings.email_marketing) ? 'Enabled' : 'Disabled'}
            </div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {(settings.sms_appointments || settings.sms_reminders || settings.sms_marketing) ? 'Enabled' : 'Disabled'}
            </div>
            <p className="text-xs text-muted-foreground">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {(settings.push_appointments || settings.push_reminders || settings.push_marketing) ? 'Enabled' : 'Disabled'}
            </div>
            <p className="text-xs text-muted-foreground">
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-muted-foreground">
            Notification settings form is not yet implemented.
          </div>
        </CardContent>
      </Card>
