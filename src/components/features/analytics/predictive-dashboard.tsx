          ...
          <CardContent>
            <div className="flex items-center gap-2">
              ...
              <span className="text-2xl font-bold">
                {demandForecast.forecast.slice(0, 7).reduce((sum: number, day: any) => sum + day.predicted, 0)}
              </span>
            </div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="flex items-center gap-2">
              ...
              <span className="text-2xl font-bold">
                {formatCurrency(
                  revenueProjection.projections.reduce((sum: number, month: any) => sum + month.projected, 0)
                )}
              </span>
            </div>
            <p className="text-xs text-muted-foreground mt-1">
          ...
          <Card>
            ...
            <CardContent>
              ...
              <div className="mt-6 grid gap-4 md:grid-cols-7">
                {demandForecast.forecast.slice(0, 7).map((day: any) => (
        ...
        <TabsContent value="revenue" className="space-y-4">
          <Card>
            ...
            <CardContent>
              ...
              {/* Projection Details */}
              <div className="mt-6 space-y-3">
                {revenueProjection.projections.map((month: any) => (
