...
async function trackSmsFailed(
  ...
  try {
    ...
    console.error('Error tracking SMS failed:', error)
  }
}
...
async function trackTransactionalSms(params: {
  ...
  try {
    ...
    console.error('Error tracking transactional SMS:', error)
  }
}
...
async function updateCampaignSmsMetrics(
  ...
  try {
    ...
    console.error('Error updating campaign SMS metrics:', error)
  }
}
