...
import { RevenueChart } from '@/components/salon-owner/charts/revenue-chart'
    ...
    <div className="container mx-auto py-6 space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {formatCurrency(typeof dailyRevenue.currentRevenue === 'number' ? dailyRevenue.currentRevenue : 0)}
            </div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {formatCurrency(typeof weeklyRevenue.currentRevenue === 'number' ? weeklyRevenue.currentRevenue : 0)}
            </div>
            <div className="flex items-center gap-1 mt-1">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {formatCurrency(typeof monthlyRevenue.currentRevenue === 'number' ? monthlyRevenue.currentRevenue : 0)}
            </div>
            <div className="flex items-center gap-1 mt-1">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {formatCurrency(typeof yearlyRevenue.currentRevenue === 'number' ? yearlyRevenue.currentRevenue : 0)}
            </div>
            <div className="flex items-center gap-1 mt-1">
        ...
        <TabsContent value="trends" className="space-y-4">
          ...
          <div className="grid gap-4 md:grid-cols-3">
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">
                  {formatCurrency(calculateAverageTransaction(monthlyRevenue.appointments))}
                </div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">
                  {calculateTransactionCount(monthlyRevenue.appointments)}
                </div>
                <p className="text-xs text-muted-foreground mt-1">
                  This month
                </p>
