    ...
    <div className="space-y-4">
      ...
      <div className="overflow-x-auto">
        <Table>
          <TableHeader>
            <TableRow>
              <TableHead className="sticky left-0 z-10 bg-background border p-2 text-left">
                Service / Location
              </TableHead>
              {locations.map((location) => (
                <TableHead key={location.id} className="border p-2 min-w-[120px]">
          ...
          <TableBody>
            {services.map((service) => (
              <TableRow key={service.id}>
                <TableCell className="sticky left-0 z-10 bg-background border p-2">
                ...
                {locations.map((location) => {
                  ...
                  return (
                    <TableCell key={location.id} className="border p-2 text-center">
                      <TooltipProvider>
                        <Tooltip>
