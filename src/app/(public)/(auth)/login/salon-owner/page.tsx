...
import { Building, Users, TrendingUp, BarChart, ChevronRight } from 'lucide-react'
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="text-center space-y-2">
        ...
        <h1 className="text-2xl font-bold">Salon Owner Portal</h1>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-lg">Salon Management Features</CardTitle>
        </CardHeader>
        <CardContent>
