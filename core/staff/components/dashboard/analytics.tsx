...
// Import the smaller analytics components
import {
...
export function StaffAnalytics({
  ...
  const teamAverages = useMemo(() => {
    ...
    if (total === 0) return {
      revenue: 0, appointments: 0, rating: 0, utilization: 0,
      tips: 0, rebookRate: 0, clientRetention: 0
    }
      ...
      <Tabs defaultValue="overview" className="space-y-4">
        ...
        <TabsContent value="performance" className="space-y-4">
          <StaffPerformanceTable
            ...
            onStaffSelection={setSelectedStaffIds}
          />
        </TabsContent>
