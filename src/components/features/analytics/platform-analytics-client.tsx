...
interface PlatformAnalyticsClientProps {
  data: {
    ...
    revenueData: Array<{ date: string; appointments: number; revenue: number }>
    roleDistribution: Array<{ name: string; value: number }>
    salonPerformance: Array<{ name: string; appointments: number; revenue: number }>
  }
}

export function PlatformAnalyticsClient({ data }: PlatformAnalyticsClientProps) {
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{data.summary.totalSalons}</div>
            <div className="flex items-center text-xs text-muted-foreground">
        ...
        <TabsContent value="salons" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Appointments and revenue by salon</CardDescription>
            </CardHeader>
            <CardContent>
              <ResponsiveContainer width="100%" height={400}>
                <BarChart data={data.salonPerformance}>
                  <CartesianGrid strokeDasharray="3 3" />
                  <XAxis dataKey="name" />
                  <YAxis yAxisId="left" orientation="left" stroke="#8884d8" />
                  <YAxis yAxisId="right" orientation="right" stroke="#82ca9d" />
