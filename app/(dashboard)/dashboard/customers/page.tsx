    ...
    <div className="container mx-auto p-6 space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-muted-foreground mt-2">Manage and view your customer base</p>
        </div>
        <Button>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Recent customer activity and information</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="text-center py-8">
            ...
            <p className="text-sm text-muted-foreground mt-2">
              Customers will appear here once they start booking appointments
            </p>
          </div>
        </CardContent>
      </Card>
