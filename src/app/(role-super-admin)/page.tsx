    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <Link
              href="/role-super-admin/security"
              className="block mt-4 text-sm text-blue-600 hover:underline text-center"
            >
      ...
      <Card>
        ...
        <CardContent>
          <div className="grid gap-4 md:grid-cols-4">
            <Link
              href="/role-super-admin/salons/new"
              className="text-sm text-blue-600 hover:underline"
            >
              Add New Salon
            </Link>
            <Link
              href="/role-super-admin/users"
              className="text-sm text-blue-600 hover:underline"
            >
              Manage Users
            </Link>
            <Link
              href="/role-super-admin/database"
              className="text-sm text-blue-600 hover:underline"
            >
              Database Tools
            </Link>
            <Link
              href="/role-super-admin/settings"
              className="text-sm text-blue-600 hover:underline"
            >
              System Settings
            </Link>
      ...
      <Alert>
        ...
        <AlertDescription className="flex items-center justify-between">
          <span>Super Administrator access active. All actions are logged and monitored.</span>
