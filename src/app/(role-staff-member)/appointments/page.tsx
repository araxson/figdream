...
import { Card, CardContent, CardDescription, CardHeader, CardTitle, Button, Badge, Tabs, TabsContent, TabsList, TabsTrigger, Alert, AlertDescription } from '@/components/ui';
    ...
    <div className="container mx-auto p-6 max-w-7xl">
      ...
      <Alert className="mt-6">
        ...
        <AlertDescription>
          ...
          <Link href="/role-staff-member/schedule" className="font-medium underline">
            Schedule page
          </Link>.
        </AlertDescription>
      </Alert>
