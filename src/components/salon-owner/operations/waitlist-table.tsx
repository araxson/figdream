...
import { Card, CardContent, CardDescription, CardHeader, CardTitle, Button, Input, Badge, Table, TableBody, TableCell, TableHead, TableHeader, TableRow, DropdownMenu, DropdownMenuContent, DropdownMenuItem, DropdownMenuLabel, DropdownMenuSeparator, DropdownMenuTrigger, Tabs, TabsContent, TabsList, TabsTrigger } from "@/components/ui"
import { 
  Users, 
  Clock, 
  Calendar, 
      ...
      const mockWaitlist: WaitlistEntry[] = [
        {
          ...
          serviceRequested: "Hair Color & Cut",
          preferredStaff: "Sarah Johnson",
          preferredDate: "2024-12-25",
          preferredTime: "2:00 PM",
          flexibleSchedule: true,
          addedAt: "2024-12-20T10:00:00",
          position: 1,
          status: 'waiting',
        ...
        },
        {
          ...
          serviceRequested: "Men's Haircut",
          preferredStaff: "Any available",
          flexibleSchedule: false,
          addedAt: "2024-12-20T11:30:00",
          position: 2,
          status: 'contacted',
          lastContactedAt: "2024-12-20T14:00:00",
          notes: "Called - waiting for response",
        ...
        },
        {
          ...
          serviceRequested: "Manicure & Pedicure",
          preferredDate: "2024-12-24",
          flexibleSchedule: true,
          addedAt: "2024-12-19T15:00:00",
          position: 3,
          status: 'waiting',
          estimatedWaitTime: "3-4 days"
        }
      ]
