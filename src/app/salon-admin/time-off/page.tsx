...
import TimeOffApprovalActions from './components/time-off-approval-actions'
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex gap-4">
                        <Avatar>
                          ...
                          <AvatarFallback>
                            {request.staff_profiles?.display_name?.[0] || 'S'}
                          </AvatarFallback>
                        </Avatar>
                        <div className="space-y-1">
                          <div className="flex items-center gap-2">
                            <p className="font-medium">
                              {request.staff_profiles?.display_name || 'Staff Member'}
                            </p>
